...
리스트 만들어서 추가
2. set하나 만들어서, 리스트에 있는 요소들을 넣고 중복 제거하기 =>제거한 후 set 출력
3. 정렬을 위해서 다시 List를 하나 만들고, set에 있던 요소들을 List에 넣기
4. 요소들을 넣은 리스트를 정렬하고 정렬된 언어 목록 출력하기
5. serachLang 변수에 "Java" 대입하고, 해당 변수를 이용해서 리스트에서 몇개 있는지 출력(검색)
6. 중복 제거를 위해 만들었떤 set를 이용해서 중복제거된 후의 언어 개수 출력하기
